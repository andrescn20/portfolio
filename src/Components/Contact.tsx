...
const Contact: React.FC<Props> = ({
  ...
  const appear = () => {
    return scrollPosition >= contactPosition - 500 ? 'appear' : 'dissapear';
  };
  ...
  return (
    <div className='contact' id='contact' ref={contactRef}>
      <div className='ovalSeparation'></div>
      <div className='gridContainer'>
        ...
        <div className='contact-info'>
          ...
          <p className='contact-infoContent'>
            ...
            enjoy too much: the freedom of creativity engulfed by the power of
            code. Ideas and imagination might be the foundation of creation, but
            the struggle of bringing them to life is what makes me thrive.{' '}
          </p>
        </div>
        <div className='pseudoFooter'>
          ...
          <p>
            I appreciate you made it this far. Hope you enjoyed my Portfolio.{' '}
          </p>
        </div>
      </div>
    </div>
